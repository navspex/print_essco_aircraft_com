    ...
    <div className="min-h-screen bg-slate-900">
      ...
      <section className="relative overflow-hidden" style={{ backgroundImage: 'url(/images/FAQ_background.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className="relative text-center px-5 py-16 md:py-20 max-w-5xl mx-auto">
          ...
          <button className="bg-amber-500 hover:bg-amber-400 text-slate-900 text-lg font-bold uppercase tracking-wide px-8 py-4 rounded-lg shadow-xl transition-all duration-300 transform hover:scale-110 hover:-translate-y-1 hover:shadow-2xl hover:shadow-amber-500/50 inline-flex items-center gap-3" style={{ fontFamily: "'Oswald', sans-serif" }}>
            <Calculator size={24} strokeWidth={2.5} className="transition-transform duration-300 group-hover:rotate-12" />
      ...
      <section className="py-12 bg-slate-900 border-y border-slate-700">
        <div className="max-w-6xl mx-auto px-5 text-center">
          ...
          <div className="flex flex-col md:flex-row justify-around gap-8 mb-8">
            <div className="flex flex-col items-center p-4 rounded-xl transition-all duration-300 hover:scale-110 hover:bg-slate-800/50 cursor-default">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 text-sm text-slate-400">
            <span className="flex items-center gap-2 p-2 rounded-lg transition-all duration-300 hover:text-white hover:bg-slate-700/50"><Lock size={16} className="text-green-500" />Secure Upload</span>
            <span className="flex items-center gap-2 p-2 rounded-lg transition-all duration-300 hover:text-white hover:bg-slate-700/50"><Zap size={16} className="text-amber-400" />Same-Day Available</span>
            <span className="flex items-center gap-2 p-2 rounded-lg transition-all duration-300 hover:text-white hover:bg-slate-700/50"><Plane size={16} className="text-blue-400" />Aviation Specialists</span>
          </div>
      ...
      <section className="relative py-12" style={{ backgroundImage: 'url(/images/trust_background.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className="relative max-w-4xl mx-auto px-5 text-center">
          <a href="https://www.ebay.com/fdbk/feedback_profile/esscoaircraft" target="_blank" rel="noopener noreferrer" className="block">
            <img src="/images/ebay-feedback.jpg" alt="eBay verified seller with 17000 positive reviews" className="w-full max-w-2xl mx-auto rounded-lg transition-all duration-300 hover:scale-[1.03] hover:shadow-2xl hover:shadow-amber-500/30" style={{ boxShadow: '0 3px 12px rgba(0, 0, 0, 0.4)' }} />
          </a>
      ...
      <section className="py-16 bg-slate-800">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-8">
            <div className="bg-slate-800 rounded-xl overflow-hidden border border-slate-700 transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:shadow-amber-500/10 hover:border-slate-600">
              ...
              <div className="p-4">
                <table className="w-full">
                  ...
                  <tbody>
                    <tr className="border-b border-slate-700 transition-colors hover:bg-slate-700/50"><td className="py-3 text-white">Black & White</td><td className="text-center text-slate-300">$0.32</td><td className="text-center text-slate-300">$0.24</td><td className="text-center text-amber-400 font-bold">$0.21</td></tr>
                    <tr className="transition-colors hover:bg-slate-700/50"><td className="py-3 text-white">Full Color</td><td className="text-center text-slate-300">$0.89</td><td className="text-center text-slate-300">$0.59</td><td className="text-center text-amber-400 font-bold">$0.49</td></tr>
                  </tbody>
                </table>
            ...
            <div className="bg-slate-800 rounded-xl overflow-hidden border border-slate-700 transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:shadow-amber-500/10 hover:border-slate-600">
              ...
              <div className="p-4">
                <table className="w-full"><tbody>
                  <tr className="border-b border-slate-700 transition-colors hover:bg-slate-700/50"><td className="py-3 text-white">Spiral Binding <span className="px-2 py-0.5 bg-green-900 text-green-400 text-xs font-medium rounded-full ml-2">Popular</span></td><td className="text-right text-amber-400 font-semibold">$3.50</td></tr>
                  <tr className="border-b border-slate-700 transition-colors hover:bg-slate-700/50"><td className="py-3 text-white">Comb Binding</td><td className="text-right text-slate-300">$2.50</td></tr>
                  <tr className="border-b border-slate-700 transition-colors hover:bg-slate-700/50"><td className="py-3 text-white">Perfect Binding <span className="text-slate-500 text-xs">(glued spine)</span></td><td className="text-right text-slate-300">$8.00</td></tr>
                  <tr className="transition-colors hover:bg-slate-700/50"><td className="py-3 text-white">3-Ring Ready (No Binding)</td><td className="text-right text-green-400">FREE</td></tr>
                </tbody></table>
              </div>
            </div>
          </div>

          <div className="max-w-4xl mx-auto mt-8 bg-blue-900/30 border border-blue-700 rounded-lg p-6 transition-all duration-300 hover:bg-blue-900/40 hover:border-blue-600">
      ...
      <section className="relative py-16" style={{ backgroundImage: 'url(/images/why_us.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <div className="bg-slate-700/50 rounded-xl p-6 border border-slate-600 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-amber-500/20 hover:border-amber-500/50 group">
              <Building2 className="w-10 h-10 text-amber-400 mb-4 transition-transform duration-300 group-hover:scale-110" />
            ...
            <div className="bg-slate-700/50 rounded-xl p-6 border border-slate-600 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-amber-500/20 hover:border-amber-500/50 group">
              <Printer className="w-10 h-10 text-amber-400 mb-4 transition-transform duration-300 group-hover:scale-110" />
            ...
            <div className="bg-slate-700/50 rounded-xl p-6 border border-slate-600 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-amber-500/20 hover:border-amber-500/50 group">
              <Users className="w-10 h-10 text-amber-400 mb-4 transition-transform duration-300 group-hover:scale-110" />
            ...
            <div className="bg-slate-700/50 rounded-xl p-6 border border-slate-600 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-amber-500/20 hover:border-amber-500/50 group">
              <Zap className="w-10 h-10 text-amber-400 mb-4 transition-transform duration-300 group-hover:scale-110" />
            ...
            <div className="bg-slate-700/50 rounded-xl p-6 border border-slate-600 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-amber-500/20 hover:border-amber-500/50 group">
              <ThumbsUp className="w-10 h-10 text-amber-400 mb-4 transition-transform duration-300 group-hover:scale-110" />
            ...
            <div className="bg-slate-700/50 rounded-xl p-6 border border-slate-600 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-amber-500/20 hover:border-amber-500/50 group">
              <ShieldCheck className="w-10 h-10 text-amber-400 mb-4 transition-transform duration-300 group-hover:scale-110" />
        ...
        <div className="relative max-w-4xl mx-auto px-4">
          ...
          <div className="space-y-4">
            {[
              ...
              <details key={idx} className="bg-slate-700/50 rounded-xl border border-slate-600 group transition-all duration-300 hover:border-amber-500/50 hover:shadow-lg hover:shadow-amber-500/10">
                <summary className="flex items-center justify-between p-5 cursor-pointer font-semibold text-white list-none hover:bg-slate-700/70 rounded-xl transition-all duration-300 group-hover:text-amber-400">{faq.q}<svg className="w-5 h-5 text-slate-400 transition-transform duration-300 group-open:rotate-180 group-hover:text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" /></svg></summary>
      ...
      <section className="bg-amber-500 py-12">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <a href="#calculator" className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold text-white bg-slate-900 hover:bg-slate-800 rounded-lg transition-all duration-300 shadow-lg hover:shadow-2xl hover:shadow-slate-900/50 hover:scale-105 hover:-translate-y-1">SEE MY PRICE →</a>
        </div>
      </section>
      ...
      <footer className="bg-slate-900 text-slate-400 border-t border-slate-800">
          ...
          <div className="max-w-7xl mx-auto px-4 py-6">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-6 text-sm">
                <a href="tel:877-318-1555" className="flex items-center gap-2 hover:text-amber-400 transition-all duration-300 hover:scale-105"><Phone className="w-4 h-4" />877-318-1555</a>
                <a href="mailto:dale@esscoaircraft.com" className="flex items-center gap-2 hover:text-amber-400 transition-all duration-300 hover:scale-105"><Mail className="w-4 h-4" />dale@esscoaircraft.com</a>
        ...
        <div className="flex justify-center items-center gap-6 py-4 border-t border-slate-800">
          <div className="flex items-center gap-2 text-sm transition-all duration-300 hover:text-green-400 hover:scale-105 cursor-default"><ShieldCheck size={20} className="text-green-500" /><span>Secure Checkout</span></div>
          <div className="flex items-center gap-2 text-sm transition-all duration-300 hover:text-blue-400 hover:scale-105 cursor-default"><CreditCard size={20} className="text-blue-400" /><span>PayPal Accepted</span></div>
          <div className="flex items-center gap-2 text-sm transition-all duration-300 hover:text-amber-400 hover:scale-105 cursor-default"><Award size={20} className="text-amber-400" /><span>70 Years Trusted</span></div>
        </div>
