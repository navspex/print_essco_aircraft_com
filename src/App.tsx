...
function App() {
  return (
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="content-container">
          <div className="flex items-center justify-between h-16">
            ...
            <a href="https://esscoaircraft.com" className="flex items-center gap-3">
              ...
              />
              <span className="text-white font-bold text-xl">ESSCO Aircraft</span>
            </a>
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              <a href="tel:877-318-1555" className="text-amber-400 hover:text-amber-300 font-semibold flex items-center gap-1">
      ...
      {/* ==================== HERO SECTION ==================== */}
      {/* VERIFIED: Using linear-gradient overlay in backgroundImage (2025 best practice) */}
      <section 
      ...
      <section className="bg-slate-800 py-10 border-y border-slate-700">
        <div className="content-container">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              <div className="text-3xl md:text-4xl font-bold text-amber-400 mb-2">34,000+</div>
              <div className="text-gray-300 text-sm">Orders Completed</div>
            </div>
            <div>
      ...
      {/* ==================== TRUST / ABOUT SECTION ==================== */}
      {/* VERIFIED: Light overlay with high opacity for dark text readability */}
      <section 
        id="about"
        ...
        <div className="content-container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex justify-center mt-8">
              ...
              >
                <img 
                  src="/images/ebay-feedback.png" 
                  alt="ESSCO Aircraft eBay Feedback - 100% Positive Rating" 
                  className="h-20 w-auto mx-auto"
                  onError={(e) => { 
                    const parent = (e.currentTarget as HTMLImageElement).parentElement;
                    if (parent) parent.innerHTML = '<div class="text-center"><div class="text-2xl font-bold text-green-600">100% Positive</div><div class="text-gray-600">eBay Feedback</div><div class="text-sm text-gray-500 mt-1">17,000+ Reviews</div></div>'
                  }}
                />
      ...
      {/* ==================== PRICING SECTION ==================== */}
      {/* VERIFIED: Dark overlay for white text on equipment image */}
      <section 
        id="pricing"
        className="py-20 bg-cover bg-center bg-no-repeat"
        style={{ 
          backgroundImage: "linear-gradient(rgba(15, 23, 42, 0.75), rgba(15, 23, 42, 0.75)), url('/images/Pricing_background.jpg')" 
        }}
      >
        <div className="content-container">
      ...
      {/* VERIFIED: Light overlay for blueprint room background */}
      <section 
        className="py-20 bg-cover bg-center bg-no-repeat"
        style={{ 
          backgroundImage: "linear-gradient(rgba(255, 255, 255, 0.90), rgba(255, 255, 255, 0.90)), url('/images/why_us.jpg')" 
        }}
      >
        <div className="content-container">
      ...
      <section id="calculator" className="bg-slate-100 py-20">
        <div className="content-container">
          ...
          {/* 
            =====================================================
            YOUR EXISTING CALCULATOR COMPONENT GOES HERE
            Keep all existing calculator functionality intact
            Example: <Calculator />
            =====================================================
          */}
          <div className="bg-white rounded-2xl shadow-xl p-8 max-w-4xl mx-auto">
            <div className="text-center text-slate-500 py-12 border-2 border-dashed border-slate-200 rounded-xl">
              <svg className="w-16 h-16 mx-auto text-slate-300 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
              <p className="text-lg font-medium">Calculator Component</p>
              <p className="text-sm mt-2">Your existing calculator functionality renders here</p>
            </div>
          </div>
      ...
      {/* ==================== FAQ SECTION ==================== */}
      {/* VERIFIED: Dark overlay on runway/aircraft view - strong differentiator image */}
      <section 
        id="faq"
        className="py-20 bg-cover bg-center bg-no-repeat"
        style={{ 
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            ...
            <details className="bg-white/95 rounded-xl shadow-lg group">
              <summary className="flex items-center justify-between p-6 cursor-pointer font-semibold text-slate-800 list-none">
                ...
                <svg className="w-5 h-5 text-slate-500 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="content-container">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <a href="https://esscoaircraft.com" className="hover:text-amber-400 transition">
