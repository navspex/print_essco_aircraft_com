  ...
  return (
    <div className="min-h-screen bg-slate-900 overflow-x-hidden">
      ...
      <section className="bg-zoom-container py-16 transition-all duration-500 hover:shadow-2xl hover:shadow-amber-500/30 hover:scale-[1.01] origin-center">
        <div className="bg-zoom-layer" style={{ backgroundImage: 'url(/images/print_room.png)' }}></div>
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-300 max-w-3xl mx-auto">Our facility at KLPR Lorain County Regional Airport—centrally located between KCLE Cleveland Hopkins, KCAK Akron-Canton, and KYNG Youngstown—houses over $100,000 in commercial-grade printing and finishing equipment. We've invested in the same professional machinery used by commercial print shops and major publishers because aviation professionals deserve nothing less than exceptional quality.</p>
          </div>
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 gap-2 mb-12 max-w-6xl mx-auto">
            ...
            <div className="aspect-square overflow-hidden rounded-lg">
              <img src="/images/equip-hp-designjet.png" alt="KIP 860 Wide Format Printer" className="w-full h-full object-cover transition-transform duration-500 hover:scale-105" />
            </div>
            <div className="aspect-square overflow-hidden rounded-lg">
      ...
      <ScrollReveal delay={300}>
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-6 py-4 border-t border-slate-800">
          ...
          <div className="border-t border-slate-800"><div className="max-w-7xl mx-auto px-4 py-4"><p className="text-sm text-center">&copy; {new Date().getFullYear()} ESSCO Aircraft. Veteran-Owned Business | Woman-Owned Business. All rights reserved.</p></div></div>
        </footer>
      </ScrollReveal>
